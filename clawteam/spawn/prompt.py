...
def build_agent_prompt(
    ...
    lines.extend([
        ...
        "- 默认内部协作消息、阶段汇报、最终总结一律使用简体中文；除非用户明确要求英文，否则不要输出英文消息流。",
        ...
        f'  `clawteam inbox send {team_name} {leader_name} "任务已完成：<简要总结>"`',
        "- If you are blocked or need help, message the leader:",
        f'  `clawteam inbox send {team_name} {leader_name} "需要协助：<问题描述>"`',
